      ...
      <ul className="collection">
       {job.applications.length ?
           job.applications.map(app =>
            ...
            <div style={{padding:'7px'}}><div onClick={()=>{this.props.history.push('/user/'+app._id)}} className='chip'><img src={app.photo} alt="Contact Person"/>{app.Applicant_id.First+' '+app.Applicant_id.Last}</div></div>
