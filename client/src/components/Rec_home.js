  ...
  getjobslist = () => {
    return this.state.jobs.map(job => (
      <li className="collection-item" style={{ padding: "20px" }} key={job._id}>
        <div className="row">
          <span style={{ fontSize: "20px" }} className="left blue-text">
            Title : {job.title}
          </span>
        </div>
            ...
            job.applications.map(app => (
              ...
              >
                <div style={{ padding: "7px" }}>
                  <p className="chip">
                    {app.Applicant_id.First + " " + app.Applicant_id.Last}
                  </p>
                </div>
                ...
                <a
                  className="waves-light row center"
                  href={app.Applicant_id.resume}
                  download="resume.pdf"
                >
                  <i className="material-icons right">save</i>Resume
                </a>
              </li>
            ))
          ) : (
            <div style={{ padding: "20px" }} className="center result">
    ...
    return (
      <div>
        ...
        <div className="container" id="index-recruiter">
          <div className="row">
            <div
              className="col s5 collection z-depth-5 job"
              style={{ marginRight: "20px" }}
            >
              <div className="center-align" style={{ marginTop: "10px" }}>
                <label>
                  <h1 className="chip" style={{ fontSize: "20px" }}>
                    Add A Job
                  </h1>
                </label>
              </div>
            ...
            <div className="col s6 collection z-depth-5 job">
              <div className="center-align" style={{ marginTop: "10px" }}>
                <label>
                  <h1 className="chip" style={{ fontSize: "20px" }}>
                    Jobs
              ...
              <ul className="collection">
                {this.state.jobs.length ? (
                  ...
                  <div className="center-align result">No jobs found</div>
                )}
              </ul>
            </div>
          </div>
